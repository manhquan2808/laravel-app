        ...
        <div class="p-4">
            <div class="welcome">
                <div class="content rounded-3 p-3" >
                    ...
                    <p class="mb-0">Hello <span class="main-color">{{ " Ten nhan vien"}}</span>, welcome to your awesome dashboard!</p>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="box d-flex rounded-2 align-items-center mb-4 mb-lg-0 p-3">
                            <i class="bi bi-envelope fs-2 text-center bg-primary rounded-circle"></i>
                            <div class="ms-3">
